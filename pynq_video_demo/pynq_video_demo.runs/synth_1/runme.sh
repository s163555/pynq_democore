...
HD_PWD='C:/Users/jephin/Git-projects/pynq_video_demo/pynq_video_demo/pynq_video_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moire_pattern_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moire_pattern_gen.tcl
